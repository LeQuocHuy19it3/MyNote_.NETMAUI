...
namespace MyNote.ViewModels
{
    ...
    {
        public ObservableCollection<DatesModel> WeekDays { get; set; } = new ObservableCollection<DatesModel>();
        ...
        public void AddAllScheduleList()
        {
            ...
            scheduleList.Add(new ScheduleModel
            {
                ...
                BackgroundColor = Color.FromRgba("#68c6da"),
            });
            scheduleList.Add(new ScheduleModel
            {
                Title = "App Design",
                ...
                BackgroundColor = Color.FromRgba("#e87a3d"),
            });
            scheduleList.Add(new ScheduleModel
            {
                Title = "App Design",
                ...
                EndDateTime = DateTime.Now.Date.AddDays(1).Add(new TimeSpan(16, 0, 0, 0)),
                BackgroundColor = Color.FromRgba("#9a6ead"),
            });
            scheduleList.Add(new ScheduleModel
            {
                Title = "App Design",
                ...
                EndDateTime = DateTime.Now.Date.AddDays(1).Add(new TimeSpan(18, 0, 0, 0)),
                BackgroundColor = Color.FromRgba("#eaab43"),
            });
        ...
        private void GetWeekDaysInfo()
        {
            ...
            for (int i = 0; i < 7; i++)
            {
                var recordToAdd = new DatesModel
                {
        ...
        [RelayCommand]
        public void WeekDaysSelected(DatesModel item)
        {
